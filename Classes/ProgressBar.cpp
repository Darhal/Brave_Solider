...
ProgressBar::ProgressBar(
	Node* beatup, std::string front_sprite_path, std::string back_sprite_path,
...
)
{
	...
	this->lbl = Label::createWithTTF("", "fonts/Marker Felt.ttf", 40);
...
void ProgressBar::update_string(std::string msg)
{
	...
	auto label = Label::createWithTTF(msg, "fonts/Marker Felt.ttf", font_size);
	this->lbl = label;
